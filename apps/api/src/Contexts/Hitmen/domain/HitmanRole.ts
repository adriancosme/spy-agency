...
export class HitmanRole extends EnumValueObject<string> {
  static readonly HITMAN = new HitmanRole(
    HitmanRoleEnum.HITMAN,
    Object.values(HitmanRoleEnum),
  );
  static readonly MANAGER = new HitmanRole(
    HitmanRoleEnum.MANAGER,
    Object.values(HitmanRoleEnum),
  );
  static readonly BOSS = new HitmanRole(
    HitmanRoleEnum.BOSS,
    Object.values(HitmanRoleEnum),
  );
